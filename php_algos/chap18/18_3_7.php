 ...
 * 
 * Re-write the script of the previous exercise to validate data input.
 * An error message must be displayed when the user enters an invalid
 * value.
 */
...
$msg = match (true) {
  ...
  default => 'Error: Please enter an integer between -9999 and 9999',
};
