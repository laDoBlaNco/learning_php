...
// The php7 dsa book shows php 5 and below being 14MB for php array and 6 for splfixed
// It then shows for php7 5MB and 2MB
// But when I do this with php8.3 I get a difference of 3MB and 2MB. I guess this means
// that php8 as improved even more on memory usage.

// But its also stated to be faster (SplFixedArray) in execution compared to the general
// php array operations such as accessing values, assigning values, etc.
