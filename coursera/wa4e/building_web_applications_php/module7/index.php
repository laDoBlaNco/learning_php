<!DOCTYPE html>
<head><title>Kevin Whiteside MD5 Cracker</title></head>
<body>
<h1>MD5 cracker</h1>
<p>This application takes an MD5 hash
of a four-character lower case string or pin and 
    ...
    for($i=0; $i<strlen($txt); $i++ ) {
      ...
      for($j=0; $j<strlen($txt); $j++ ) {
        ...
        for($k=0; $k<strlen($txt); $k++ ) {
          ...
          // Our inner inner inner loop. Note the use of new variables
          // $l and $ch4 
