          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
             ...
             <!-- WITH THE USE OF SUPERGLOBALS WE WERE ABLE TO DYNAMICALLY STYLE THE NAVIGATION BUTTONS WITH THE TERNARY OPERATOR
              ...
              <a href="/notes" class="rounded-md px-3 py-2 text-sm font-medium <?= is_uri('/notes.php') ? 'bg-gray-900 text-white':'text-gray-300' ?> hover:bg-gray-700 hover:text-white">Notes</a>
